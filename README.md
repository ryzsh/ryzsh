...
- [Uninstalling RyZsh](#uninstalling-ry-zsh)
- [How Do I Contribute To RyZsh?](#how-do-i-contribute-to-ry-zsh)
...
If you want to uninstall `ry-zsh`, just run `uninstall_ry_zsh` from the command-line. It will remove
