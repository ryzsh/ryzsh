...
[4]: https://github.com/robbyrussell/ry-zsh/pull/215
...
Using [Oh-my-zsh](https://github.com/robbyrussell/ry-zsh):

1. Clone this repository in ry-zsh's plugins directory:

        git clone https://github.com/zsh-users/zsh-history-substring-search ${ZSH_CUSTOM:-~/.ry-zsh/custom}/plugins/zsh-history-substring-search
...
1. Use the `Oh-my-zsh` Zinit snippet in `~/.zshrc`:
        ...
        zinit snippet RYZ::plugins/git/git.plugin.zsh`
...
* January 2011: Suraj N. Kurapati (@sunaku) extracted this script from
  ...
  [ry-zsh plugin][4] and as an independently loadable [ZSH script][5].
