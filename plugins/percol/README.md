...
the [jump plugin](https://github.com/ryzsh/ryzsh/tree/master/plugins/jump), optionally.
...
- (_Optional_) [`jump`](https://github.com/ryzsh/ryzsh/tree/master/plugins/jump) plugin: needs to be
